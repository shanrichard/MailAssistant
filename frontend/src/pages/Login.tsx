...
const Login: React.FC = () => {
  ...
  if (isAuthenticated) {
    return <Navigate to={ROUTES.DAILY_REPORT} replace />;
  }
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <img 
            ...
            className="mx-auto h-32 w-32 sm:h-28 sm:w-28 mb-6 object-contain"
          />
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            Welcome to MailAssistant
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Your intelligent email management assistant
          </p>
        </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    We use Google OAuth for secure authentication. Your emails are processed locally and never stored permanently.
                  </p>
                </div>
              </div>
            </div>
